...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'F:\New folder\Fake_Profile_Detection_using_ML_and_dd\flask'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'F:\New folder\Fake_Profile_Detection_using_ML_and_dd\flask\Scripts\deactivate.nu'
